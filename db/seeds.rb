...
create_with_id 1,  Condition.new(:guide_type_id => 2, :group => "day",       :name => "Morning", :weather => "sunny", :full_name => "Sunny Weather Morning")
create_with_id 2,  Condition.new(:guide_type_id => 2, :group => "day",       :name => "Morning", :weather => "lousy", :full_name => "Lousy Weather Morning")
create_with_id 3,  Condition.new(:guide_type_id => 2, :group => "day",       :name => "Lunch", :full_name => "Lunch")
create_with_id 4,  Condition.new(:guide_type_id => 2, :group => "day",       :name => "Afternoon", :weather => "sunny", :full_name => "Sunny Weather Afternoon")
create_with_id 5,  Condition.new(:guide_type_id => 2, :group => "day",       :name => "Afternoon", :weather => "lousy", :full_name => "Lousy Weather Afternoon")
...
create_with_id 12, Condition.new(:guide_type_id => 1, :group => nil,         :name => "Day", :weather => "sunny", :full_name => "Sunny Weather Day")
create_with_id 13, Condition.new(:guide_type_id => 1, :group => nil,         :name => "Day", :weather => "lousy", :full_name => "Lousy Weather Day")
...
create_with_id 3, GuideLayout.new(:name => 'horizontal', :path => 'horizontal', :public => true)
create_with_id 4, GuideLayout.new(:name => 'full', :path => 'full', :public => true)
